    ...
    if ($msg == '') {
        if (isset($_GET['id']) && $_GET['id'] != '') {
            if ($_FILES['image']['name'] != '') {
                ...
                mysqli_query($con, "UPDATE `services` SET `title`='$title',`short_description`='$short_description', `image`='$image',`image_alt_tag`='$image_alt_tag',`description`='$description', `url`='$url',`meta_title`='$meta_title',`meta_desc`='$meta_desc' WHERE `id`='$id'");
            } else {
                $update_query = "UPDATE `services` SET `title`='$title',`short_description`='$short_description', `image`='$image',`image_alt_tag`='$image_alt_tag',`description`='$description',`url`='$url',`meta_title`='$meta_title',`meta_desc`='$meta_desc' WHERE `id`='$id'";
            ...
            move_uploaded_file($_FILES['image']['tmp_name'], "../../Uploads/services/" . $image);
            $insert_query = "INSERT INTO `services`(`title`, `short_description`, `image`,`image_alt_tag`, `description`, `url`, `meta_title`,`meta_desc`) 
            VALUES ('$title','$short_description', '$image','$image_alt_tag','$description','$url', '$meta_title','$meta_desc')";
