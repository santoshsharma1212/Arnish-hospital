    ...
    if ($msg == '') {
        if (isset($_GET['id']) && $_GET['id'] != '') {
            if ($_FILES['image']['name'] != '') {
                ...
                mysqli_query($con, "UPDATE `doctors` SET `title`='$title',`short_description`='$short_description', `image`='$image',`department`='$department',`description`='$description', `doctor_url`='$doctor_url',`meta_title`='$meta_title',`meta_desc`='$meta_desc' WHERE `id`='$id'");
            } else {
                $update_query = "UPDATE `doctors` SET `title`='$title',`short_description`='$short_description', `image`='$image',`department`='$department',`description`='$description',`doctor_url`='$doctor_url',`meta_title`='$meta_title',`meta_desc`='$meta_desc' WHERE `id`='$id'";
            ...
            move_uploaded_file($_FILES['image']['tmp_name'], "../../Uploads/doctors/" . $image);
            $insert_query = "INSERT INTO `doctors`(`title`, `short_description`, `image`,`department`, `description`, `doctor_url`, `meta_title`,`meta_desc`) 
            VALUES ('$title','$short_description', '$image','$department','$description','$doctor_url', '$meta_title','$meta_desc')";
                ...
                <div class="card">
                    ...
                    <form method="post" enctype="multipart/form-data">
                        <div class="card-body card-block">
                            ...
                            <div class="form-group">
                                <label for="Alt_tag" class=" form-control-label"> Department</label>
                                <input type="text" name="department" placeholder="Enter Image Alt Tag" class="form-control" required value="<?php echo $department ?>">
                            </div>
                            <div class="form-group">
                             ...
                             <div class="form-group">
                                <label for="doctors_url" class=" form-control-label">Doctor URL</label>
                                <input type="text" name="doctors_url" placeholder="Enter doctor Url" class="form-control" required value="<?php echo $doctor_url ?>">
                            </div>
                             <div class="form-group">
