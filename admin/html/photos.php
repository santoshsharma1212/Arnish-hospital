    ...
    if ($msg == '') {
        if (isset($_GET['id']) && $_GET['id'] != '') {
            if ($_FILES['image']['name'] != '') {
                ...
                mysqli_query($con, "UPDATE `photos` SET `image`='$image',`image_alt_tag`='$image_alt_tag' WHERE `id`='$id'");
            } else {
                $update_query = "UPDATE `photos` SET `image`='$image',`image_alt_tag`='$image_alt_tag' WHERE `id`='$id'";
           ...
           $image = rand(111111111, 999999999) . '_' . $_FILES['image']['name'];
            ...
            $insert_query = "INSERT INTO `photos` (`image`, `image_alt_tag`) 
